      ...
      <form action="" method="POST">
         ...
         <div class="flex">
            <div class="box">
               ...
               <input type="text" name="address" required maxlength="50" placeholder="enter your address" class="input">
            </div>
         </div>
      ...
      <div class="summary">
         ...
         <div class="flex">
            ...
            <div>
               ...
               <p class="price"><i class="fas fa-peso-sign"></i> <?= $fetch_get['price']; ?> x 1</p>
            </div>
         </div>
         <?php
               }
         ...
         <div class="flex">
            ...
            <div>
               ...
               <p class="price"><i class="fas fa-peso-sign"></i> <?= $fetch_product['price']; ?> x <?= $fetch_cart['qty']; ?></p>
            </div>
         </div>
         <?php
                  }
